...
export default function Analytics() {
  return (
    <DashboardLayout>
      <div>
        <h3 className="text-xl font-medium text-gray-500">Analytics</h3>
              ...
              <table className="min-w-full">
                ...
                <tbody className="bg-white">
                  <tr>
                    ...
                    <td className="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                      <span className="inline-flex px-2 text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-full">{` u.status `}</span>
                    </td>
